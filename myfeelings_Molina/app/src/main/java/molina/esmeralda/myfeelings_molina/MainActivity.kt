package molina.esmeralda.myfeelings_molina
...
import molina.esmeralda.myfeelings_molina.utilities.CustomBarDrawable
import molina.esmeralda.myfeelings_molina.utilities.CustomCircleDrawable
import molina.esmeralda.myfeelings_molina.utilities.Emociones
import molina.esmeralda.myfeelings_molina.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria(){
        ...
        if (verysad>happy && verysad>neutral && verysad>sad && veryHappy<verysad){
            icon.setImageDrawable(resources.getDrawable(R.drawable.happiness_svgrepo_com))
        }
